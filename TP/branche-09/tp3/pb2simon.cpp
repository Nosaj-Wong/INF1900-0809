 ...
 * Description: Ceci est un programme variant la led et le pwm du moteur du robot.
 * Version: 1.0
 */
...
void pwmModifier60() // fonction impose des fréquences de 60 Hz pour la fréquence de la période du signal PWM
{
    int a = 0;
    int b = 100;
...
void pwmModifier400() // fonction impose des fréquences de 400 Hz pour la fréquence de la période du signal PWM pendant 1 seconde
{
    int a = 0;
    int b = 100;
    int NBR_LEVELS_PWM = 5;
    ...
    for (int i = 0; i < NBR_LEVELS_PWM; i++) // 5 niveaux : 0%, 25%, 50%, 75% et 100%
    {
