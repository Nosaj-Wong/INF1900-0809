...
// pin 0 existe), la direction (ou 0 signifie avant et 1 arriere) et le poucentage de
// puissance entre 0 et 100
PWM::PWM(PinPWM pinPWM, uint8_t pinDirection, bool direction, uint8_t percent)
  ...
  // PWM 8 bit phase correcte et activation du mode compare
  *TCCRnA_ |= (0b11 << COMnxn_) | (1 << WGM10);
