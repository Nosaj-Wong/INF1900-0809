...
void Driver::forwardStraight() {
  ...
  switch (captorState) {
    ...
    case bigLeftDeviation:
      leftMotor_->setPercent(BASIC_SPEED + 20);
      break;

    case mediumLeftDeviation:
      leftMotor_->setPercent(BASIC_SPEED + 15);
      break;

    case smallLeftDeviation:
      leftMotor_->setPercent(BASIC_SPEED + 10);
      break;
    ...
    case smallRightDeviation:
      rightMotor_->setPercent(BASIC_SPEED + 10);
      break;
    ...
    case hugeRightDeviation:
      rightMotor_->setPercent(BASIC_SPEED + 25);
      break;
...
void Driver::backwardStraight() {
  ...
  // Si on est au centre, on recule droit, sinon on corrige rapidement
  switch (captorState) {
    case hugeLeftDeviation:
      leftMotor_->setPercent(BACKWARD_SPEED - 15);
      break;
    ...
    case smallRightDeviation:
      rightMotor_->setPercent(BACKWARD_SPEED - 15);
      break;
