...
void read(can &can, uint16_t *tableauGauche, uint16_t *tableauDroite,
  ...
  if (resultatDroite >= 207)
    ...
    resultatDroite =
        RIGHT_NUMERATOR3 / (resultatDroite - RIGHT_DENOMINATOR_CONSTANT3) +
        RIGHT_CORRECTION_CONSTANT3;

  if (resultatGauche >= 190)
    resultatGauche =
